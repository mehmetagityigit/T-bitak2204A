...
export const Navigation: React.FC<Props> = ({ profile }) => {
  ...
  return (
    <>
      ...
      {/* pb-safe adds padding for iPhone home indicator */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-navy-950/95 backdrop-blur-md border-t border-gray-200 dark:border-navy-800 pb-[env(safe-area-inset-bottom)] transition-colors duration-300 shadow-[0_-5px_10px_rgba(0,0,0,0.02)]">
        <div className="flex justify-around items-center h-16 px-1">
          ...
          <Link to="/entry" className="-mt-8">
            <div className="w-14 h-14 bg-teal-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-teal-300/50 dark:shadow-black/50 border-4 border-white dark:border-navy-900 transform transition active:scale-95">
